; $Id: //depot/Release/IDL_81/idl/idldir/lib/ts_smooth.pro#1 $
;
...
;       Modified: Compute variability in timeseries
;-

FUNCTION TS_Sigma, x, Nvalues, Backward = Backward, Double = Double, $
